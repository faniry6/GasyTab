...
const Settings: FC<Props> = props => {
  ...
  const [activeShowTablatureSelect, setActiveShowTablatureSelect] = useState(
    false,
  );
  const [
    activeEnablePageTurnerSelect,
  ...
  const [enablePageTurner, setEnablePageTurner] = useState(
