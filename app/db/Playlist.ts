...
export class Playlist {
  ...
  static buildGasyTabPlaylist() {
    if (!GlobalSettings.get().isDatabaseBuild) {
      if (Playlist.getById('3e4cbcfc-ca73-4dc8-821f-daa8bda02dc1') == null) {
        importBundle(kaiamba);
      }
      if (Playlist.getByName('7aea1e86-e827-44d7-9092-3194666175f4') == null) {
        importBundle(evanjelika);
      }
      if (Playlist.getByName('4dd5382d-e964-4648-bbe3-96bf4639c702') == null) {
        importBundle(tamboho);
      }
      GlobalSettings.setBuildDatabase(true);
    }
  }
